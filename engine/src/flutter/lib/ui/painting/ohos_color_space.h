...
constexpr uint32_t kHdrColorSpaces[] = {
    kBT2020HLG,      kBT2020PQ,      kP3HLG,      kP3PQ,
    kBT2020HLGLimit, kBT2020PQLimit, kP3HLGLimit, kP3PQLimit,
};
...
inline impeller::TextureColorSpace TextureColorSpaceForOhos(
    uint32_t colorSpace) {
  if (ContainsColorSpace(colorSpace, kHdrColorSpaces)) {
