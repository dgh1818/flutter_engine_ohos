...
bool OHOSSurface::PrepareOffscreenWindow(int32_t width, int32_t height) {
  ...
  //       offscreen_nativewindow_, SET_COLOR_GAMUT,
  ...
  //     return false;
  //   }
  //   FML_DLOG(INFO) << "set offscreen window format hdr"
  //                  << offscreen_nativewindow_;
  // } else if (offscreen_hdr_ == 0) {
  //   int ret_color_gamut = OH_NativeWindow_NativeWindowHandleOpt(
  //       offscreen_nativewindow_, SET_COLOR_GAMUT,
  //       NATIVEBUFFER_COLOR_GAMUT_NATIVE);
  //   int ret_color_format = OH_NativeWindow_NativeWindowHandleOpt(
  ...
  //     return false;
  //   }
  //   FML_DLOG(INFO) << "set offscreen window format sdr"
  //                  << offscreen_nativewindow_;
  // }
