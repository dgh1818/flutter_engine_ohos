## Version Overview
This version is the Flutter OpenHarmony platform version 0.0.1 (canary1), based on the Flutter 3.41.9. This version supports and improves the capabilities of the OpenHarmony platform, provides platform-based channels, external texture, cloud SDKs and other features, and optimizes performance.
...
## Bugfix
- Fix black screen on screen rotation
- Fix OHOS plugin registration failure
- Fix status bar tap scroll-to-top not working
- Fix setApplicationLocale not received on native side
- Fix SetSemanticsTreeEnabled not taking effect on OHOS
