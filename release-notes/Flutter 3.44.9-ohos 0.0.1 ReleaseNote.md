## 版本概述
本版本为Flutter OpenHarmony平台0.0.1版本（canary1），基于Flutter 3.44.9版本适配。本版本支持和完善OpenHarmony平台侧能力，提供平台化Channel、外接纹理、云端SDK等特性，并优化性能。
...
- Flutter SDK：**3.44.9-ohos-0.0.1**（由于flutter版本解析规则，为了避免版本比较解析失败，将显示为3.44.10-ohos-0.0.1-canary1）
