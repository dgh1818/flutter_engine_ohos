...
class OhosWorkflow implements Workflow {
  OhosWorkflow({required HarmonySdk? ohosSdk, required FeatureFlags featureFlags})
    : _ohosSdk = ohosSdk,
  ...
  @override
  bool get canListDevices => appliesToHostPlatform && _ohosSdk != null && _ohosSdk.hdcPath != null;
